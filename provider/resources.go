...
const (
	...
	mainPkg = "junos"
	// modules:
	mainMod = "index" // the junos module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	p := shimv2.NewProvider(junos.Provider())
	...
	prov := tfbridge.ProviderInfo{
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing junos cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"pulumi", "junos", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/pulumi/pulumi-junos",
	...
	prov.MustComputeTokens(tokens.SingleModule("junos_", mainMod,
