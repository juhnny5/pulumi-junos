...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `junos` with the `NAME` of your provider.
...
├── config.yaml
├── metadata.json
├── pulumi-junos_darwin_amd64_v1
│   └── pulumi-resource-junos
├── pulumi-junos_darwin_arm64
│   └── pulumi-resource-junos
├── pulumi-junos_linux_amd64_v1
│   └── pulumi-resource-junos
├── pulumi-junos_linux_arm64
│   └── pulumi-resource-junos
├── pulumi-junos_windows_amd64_v1
│   └── pulumi-resource-junos.exe
└── pulumi-junos_windows_arm64
    └── pulumi-resource-junos.exe
```
